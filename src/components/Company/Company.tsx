...
const Company = (props: Props) => {
  return (
    <>
      <div className='app-bg-color h-[512px] relative flex'>
        <div className='w-1/2 relative'>
          <Image src='/images/c.jpg' alt='as' fill className='object-cover ' />
        </div>
        <div className='max-w-screen-xl mx-auto w-1/2 px-20'>
          <div className='flex justify-between w-3/4 items-center h-full'>
            <div>
              <svg
