...
const Company = (props: Props) => {
  return (
    <>
      <div className='app-bg-color h-[512px] relative md:flex '>
        <div className='w-1/2 relative'>
          <Image src='/images/c.jpg' alt='as' fill className='object-cover ' />
        </div>
        <div className='max-w-screen-xl mx-auto md:w-1/2 md:px-20 '>
          <div className='flex justify-between md:w-3/4 items-center h-full mx-2 '>
            <div>
              <svg
      ...
      <div className='md:flex  px-2 justify-between max-w-screen-lg mx-auto md:-my-10 -my-32 gap-5 relative z-20'>
