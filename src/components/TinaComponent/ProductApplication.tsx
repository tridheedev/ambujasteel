...
type Props = {
  applications: (string | null)[] | null | undefined;
};

const ProductApplication = ({ applications }: Props) => {
  return (
    <>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 my-3 flex-col'>
        {applications?.map((app, i) => {
          return (
            <div key={i} className='flex items-center py-2 '>
              ...
              <p className='pl-2 text-gray-900'>{app}</p>
            </div>
          );
        })}
      </div>
